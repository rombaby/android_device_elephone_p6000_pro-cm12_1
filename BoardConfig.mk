...
-include vendor/elephone/p6000_pro/BoardConfigVendor.mk
#64 bit
TARGET_ARCH := arm64
...
TARGET_BOOTLOADER_BOARD_NAME := Elephone_p6000_pro
...
#recovery
#TARGET_RECOVERY_INITRC := device/elephone/p6000_pro/recovery/init.mt6753.rc
TARGET_RECOVERY_FSTAB := device/elephone/p6000_pro/recovery/root/fstab.mt6753
TARGET_RECOVERY_LCD_BACKLIGHT_PATH := \"/sys/devices/platform/leds-mt65xx/leds/lcd-backlight/brightness\"

#system.prop
TARGET_SYSTEM_PROP := device/elephone/p6000_pro/system.prop
...
BOARD_EGL_CFG := device/elephone/p6000_pro/egl.cfg
